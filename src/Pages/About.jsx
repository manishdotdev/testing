...
const whyItems = [
    {
        ...
        desc: "10+ years delivering IT solutions across industries — from startups to global enterprises.",
        icon: (
                ...
                <section className="stories-section">
                    ...
                    <div className="stories-grid reveal reveal-delay-1">
                        <div className="story-card featured">
                            ...
                            <p>In 2014, two engineers quit comfortable jobs to solve a simple problem — why was enterprise software so painful to use? That question became a company.</p>
                            <span className="story-tag">Origin Story</span>
                        </div>
                        <div className="story-card">
                            <span className="story-num">02</span>
                            <h3>From 3 clients to 300+</h3>
                        ...
                        <div className="story-card">
                            ...
                            <p>Ten years. 300+ clients. Zero incidents. We take security personally.</p>
                ...
                <section className="vision-section">
                    <div className="vision-inner">
                        <div className="vision-left reveal">
                            <div className="vision-big-num">V</div>
                        ...
                        <div className="vision-right reveal reveal-delay-2">
                            {[
                                { num: "10+", label: "Years of operation" },
                                { num: "300+", label: "Global clients" },
